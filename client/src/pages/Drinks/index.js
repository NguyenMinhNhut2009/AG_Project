        ...
        <section className="text-center">
            <div className="container bg-quaternary-500">
                <div
                    ...
                    <div className="w-[1250px] h-24 bottom-[-50px] z-10 absolute">
                        <div className="absolute inset-0 bg-secondary-500 opacity-60 -z-10 rounded-full"></div>
                        <div className="flex-center-y mx-3 justify-between absolute inset-y-2/4 left-5 right-5">
                            <Button
                                className="w-32 h-14 hover:color-white"
                                name="Hot"
                            />
                            <Button
                                className="w-32 h-14 absolute left-48 hover:color-white"
                                name="New"
                            />
